...
class Email {
    ...
    public function enviarConfirmacion() {
        ...
        $contenido .= "<p>Si no creaste esta cuenta, puedes eliminar este mensaje.</p>";
        $contenido .= '</html>';
    ...
    public function enviarInstrucciones() {
        ...
        $contenido .= "<p>Presiona aquí: <a href='http://localhost:3000/restablecer?token=" . $this->token . "'>Restablece tu Password</a></p>";
        $contenido .= "<p>Si no creaste esta cuenta, puedes eliminar este mensaje.</p>";
        $contenido .= '</html>';
